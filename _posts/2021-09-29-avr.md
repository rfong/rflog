...
This is an optional step but I did it just in case.
...
### Using Pro Micro as ISP programmer, to Pro Micro as target
...
1. Flash with DFU bootloader `.hex` file (which I downloaded from QMK). (ONLY IF SWITCHING BOOTLOADER)
```
